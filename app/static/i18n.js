...
const I18N = {
  "zh-CN": {
    ...
    mqttUnifiedHint: "同一套主机/端口/账号会写入虫洞 Agent 以及全部桥接链路（4G / Wi-Fi0 / Wi-Fi1）。",
    ...
    updateApplying: "正在下载并安装 v{version}…",
    updateRestarting: "升级完成，等待服务重启…",
    updateCheckFailed: "检查更新失败：{error}",
    updateApplyFailed: "升级失败：{error}",
  },
  en: {
    ...
    mqttUnifiedHint: "The same host/port/credentials are written to the Wormhole agent and every bridge link (4G / Wi-Fi0 / Wi-Fi1).",
    ...
    updateApplying: "Downloading and installing v{version}…",
    updateRestarting: "Upgrade done; waiting for restart…",
    updateCheckFailed: "Update check failed: {error}",
    updateApplyFailed: "Upgrade failed: {error}",
  },
};
