...
MESSAGES: dict[str, dict[str, str]] = {
    "zh-CN": {
        ...
        "job.setting_mqtt": "正在下发 MQTT（{host}:{port}，模式={mode}）…",
        "job.mqtt_set": "MQTT 已保存（{host}:{port}，模式={mode}）",
    ...
    "en": {
        ...
        "job.setting_mqtt": "Applying MQTT ({host}:{port}, mode={mode})...",
        "job.mqtt_set": "MQTT saved ({host}:{port}, mode={mode})",
